function [protrusionStats,peakStats,labeledProtrusions,labeledPeaks] = featurePicker_noFilter(mc_grid)
...
protrusionStats = protrusionStats([protrusionStats.Area] > 0);

peakStats = regionprops(labeledPeaks,mcq,'all');
peakStats = peakStats([peakStats.Area] > 0);
